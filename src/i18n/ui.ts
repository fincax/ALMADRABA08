...
export const ui = {
  es: {
    ...
    galeria: {
      ...
      videosKicker: 'En movimiento',
      toursKicker: 'Visita virtual',
      tourNote: 'Se abre en una pestaña nueva.',
      videoLabel: 'Vídeo de la casa',
  ...
  en: {
    ...
    galeria: {
      ...
      videosKicker: 'In motion',
      toursKicker: 'Virtual tour',
      tourNote: 'Opens in a new tab.',
      videoLabel: 'Video of the house',
